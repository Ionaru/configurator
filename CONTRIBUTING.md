...
Thank you so much for your interest in contributing to configurator!


## Asking questions, suggesting wonderful ideas or reporting bugs

You can [submit an issue️](https://github.com/Ionaru/configurator/issues) on this GitHub repository.
...
```bash
git clone https://github.com/Ionaru/configurator.git
cd configurator
```
...
1. [Create a fork of this project](https://github.com/Ionaru/configurator/fork).
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/configurator.git`.
3. Add the original repository as remote to keep it up-to-date: `git remote add upstream https://github.com/Ionaru/configurator.git`.
